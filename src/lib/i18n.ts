...
export const translations = {
  en: {
    ...
    widget_prompt_desc: "The Focus Flow widget shows what's due today and lets you tick things off without opening the app.",
    widget_add: "Add widget",
    widget_added: "Widget added",
    widget_not_now: "Not now",
    widget_never: "Don't ask again",
    widget_manual_hint: "Your launcher didn't open the dialog. Long-press your home screen, pick Widgets, and choose Focus Flow.",
    ...
    premium: "Premium",
    premium_title: "Focus Flow Premium",
    premium_tagline: "Use Focus Flow in your browser, with no ads on your phone.",
    ...
    premium_only_on_android: "Premium is purchased in the Focus Flow Android app.",
    premium_web_locked_title: "Premium unlocks the browser version",
    premium_web_locked_body: "Browser access is part of Focus Flow Premium. Buy it once in the Android app and this page unlocks automatically on every device you sign in to.",
    ...
    premium_still_locked: "We still can't see a purchase on this account. Open Focus Flow on your phone, make sure you're signed in with the same email, then try again.",
    premium_email_link: "Email me the link",
    premium_email_sent: "Sent — check your inbox for the link.",
    premium_email_failed: "Couldn't send the email right now. The link is above, and we'll try again later.",
    premium_email_unavailable: "Email delivery isn't set up for this build. Use the link above.",
    premium_web_link: "Browser version",
    premium_copy_link: "Copy link",
    premium_link_copied: "Link copied ✓",
  ...
  pl: {
    ...
    widget_prompt_desc: "Widżet Focus Flow pokazuje, co masz na dziś, i pozwala odhaczać zadania bez otwierania aplikacji.",
    widget_add: "Dodaj widżet",
    widget_added: "Widżet dodany",
    widget_not_now: "Nie teraz",
    widget_never: "Nie pytaj więcej",
    widget_manual_hint: "Twój launcher nie otworzył okna. Przytrzymaj palec na ekranie głównym, wybierz Widżety i znajdź Focus Flow.",
    ...
    premium: "Premium",
    premium_title: "Focus Flow Premium",
    premium_tagline: "Korzystaj z Focus Flow w przeglądarce, bez reklam w telefonie.",
    ...
    premium_only_on_android: "Premium kupuje się w aplikacji Focus Flow na Androida.",
    premium_web_locked_title: "Premium odblokowuje wersję przeglądarkową",
    premium_web_locked_body: "Dostęp z przeglądarki jest częścią Focus Flow Premium. Kup go raz w aplikacji na Androida, a ta strona odblokuje się automatycznie na każdym urządzeniu, na którym się zalogujesz.",
    ...
    premium_still_locked: "Nadal nie widzimy zakupu na tym koncie. Otwórz Focus Flow w telefonie, upewnij się, że masz ten sam e-mail, i spróbuj ponownie.",
    premium_email_link: "Wyślij mi link e-mailem",
    premium_email_sent: "Wysłane — sprawdź skrzynkę.",
    premium_email_failed: "Nie udało się teraz wysłać e-maila. Link jest powyżej, spróbujemy ponownie później.",
    premium_email_unavailable: "Wysyłka e-maili nie jest skonfigurowana w tej wersji. Skorzystaj z linku powyżej.",
    premium_web_link: "Wersja przeglądarkowa",
    premium_copy_link: "Kopiuj link",
    premium_link_copied: "Skopiowano link ✓",
