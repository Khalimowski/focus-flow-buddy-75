...
export const translations = {
  en: {
    ...
    add_time: "Add Time",
    duration_picker_title: "How long will this take?",
    add_duration: "Duration",
    duration_clear: "No duration",
    habit_repeat_on: "Repeat on",
    habit_every_day: "Every day",
    habit_days_hint: "Pick nothing and it repeats every day.",
    add_habit: "Add Habit",
    // --- Recurring events on a custom cycle (see lib/recurring.ts) ---
    cycles: "Cycles",
    cycles_title: "Recurring events",
    cycles_desc: "Things that come round every few weeks, months or years.",
    cycles_empty: "Nothing on a cycle yet. Pick one above or add your own.",
    cycle_add_title: "New recurring event",
    cycle_edit_title: "Edit recurring event",
    cycle_label_placeholder: "What comes round again?",
    cycle_next_date: "Next date",
    cycle_repeat_every: "Repeat every",
    cycle_remind_at: "Remind at",
    cycle_add: "Add event",
    cycle_mode_title: "After that, count from",
    cycle_mode_completion: "The day I tick it off",
    cycle_mode_schedule: "The same date every time",
    cycle_mode_completion_hint: "A dose given three days late pushes the next one three days out, and an overdue one keeps counting until you tick it.",
    cycle_mode_schedule_hint: "A birthday falls on the same day next year, ticked off or not.",
    cycle_next_label: "Next",
    cycle_days_left_one: "day left",
    cycle_days_left_other: "days left",
    cycle_days_over_one: "day overdue",
    cycle_days_over_other: "days overdue",
    cycle_due_today: "Due today",
    cycle_mark_done: "Mark done",
    cycle_done_toast: "Ticked off — next one {date}",
    cycle_every_n: "Every {n} {unit}",
    cycle_every_one: "Every {unit}",
    cycle_unit_day_one: "day",
    cycle_unit_day_few: "days",
    cycle_unit_day_many: "days",
    cycle_unit_week_one: "week",
    cycle_unit_week_few: "weeks",
    cycle_unit_week_many: "weeks",
    cycle_unit_month_one: "month",
    cycle_unit_month_few: "months",
    cycle_unit_month_many: "months",
    cycle_unit_year_one: "year",
    cycle_unit_year_few: "years",
    cycle_unit_year_many: "years",
    cycle_preset_pet_dose: "Flea & tick treatment",
    cycle_preset_vaccine: "Rabies vaccination",
    cycle_preset_birthday: "Birthday",
    cycle_preset_dentist: "Dentist check-up",
    cycle_notification_body: "This one is due today ✨",
    cycle_paused: "Paused",
    edit: "Edit",
    save: "Save",
    cancel: "Cancel",
    ...
    onboarding_tasks_desc: "Break your day into small, manageable wins. Set a time to get a gentle reminder, and a duration if the task should take up its real space on the timeline.",
    onboarding_habits_title: "Daily Habits",
    onboarding_habits_desc: "Gentle recurring reminders — water, meds, a stretch. Pick the times, and pick the days too: a habit can run every day, or only on the ones you choose.",
    ...
    tour_tabs_title: "Four Lists",
    tour_tabs_desc: "Tasks belong to a day, To-Do holds anything that doesn't. Habits and Cycles are the two that repeat — more on those in a moment.",
    ...
    tour_voice_desc: "Tap the mic and say the task — \"dentist tomorrow at half past four\" lands on the right day, at the right time, reminder on. Recognition runs on your device, so nothing is sent anywhere.",
    tour_voice_locked_desc: "The mic turns a spoken task into a written one — day and time included. It's part of Premium, along with FlowDay in your browser and no ads; Settings has the details.",
    tour_cycles_title: "Cycles",
    tour_cycles_desc: "For what comes round every few weeks, months or years — a flea dose every 5 weeks, a booster every year, a birthday. Each shows its next date and the days left; tick it off and the next one sets itself.",
    ...
    premium_choose_plan: "Choose how to pay",
    premium_plan_monthly: "Monthly",
    premium_plan_lifetime: "One-off",
    premium_plan_monthly_price: "{price} / month",
    premium_plan_lifetime_price: "{price} once",
    premium_plan_monthly_note: "Cancel any time in Google Play.",
    premium_plan_lifetime_note: "Pay once. Yours for good, with nothing to renew.",
    premium_plan_best_value: "Best value",
    premium_active_monthly: "Monthly plan",
    premium_active_lifetime: "One-off purchase",
    premium_renews_on: "Renews on",
    premium_ends_on: "Ends on",
    premium_manage_subscription: "Manage subscription in Google Play",
    ...
    premium_web_locked_body: "Browser access is part of FlowDay Premium. Take the monthly plan or the one-off purchase in the Android app, and this page unlocks automatically on every device you sign in to.",
  ...
  pl: {
    ...
    duration_picker_title: "Ile to zajmie?",
    add_duration: "Czas trwania",
    duration_clear: "Bez czasu trwania",
    habit_repeat_on: "Powtarzaj w dni",
    habit_every_day: "Codziennie",
    habit_days_hint: "Nic nie zaznaczasz — powtarza się codziennie.",
    add_habit: "Dodaj nawyk",
    // --- Wydarzenia cykliczne (patrz lib/recurring.ts) ---
    cycles: "Cykle",
    cycles_title: "Wydarzenia cykliczne",
    cycles_desc: "Rzeczy, które wracają co kilka tygodni, miesięcy albo lat.",
    cycles_empty: "Nie masz jeszcze żadnego cyklu. Wybierz gotowy powyżej albo dodaj własny.",
    cycle_add_title: "Nowe wydarzenie cykliczne",
    cycle_edit_title: "Edytuj wydarzenie cykliczne",
    cycle_label_placeholder: "Co ma wracać?",
    cycle_next_date: "Najbliższa data",
    cycle_repeat_every: "Powtarzaj co",
    cycle_remind_at: "Przypomnij o",
    cycle_add: "Dodaj wydarzenie",
    cycle_mode_title: "Potem licz od",
    cycle_mode_completion: "Dnia, w którym odhaczę",
    cycle_mode_schedule: "Tej samej daty za każdym razem",
    cycle_mode_completion_hint: "Dawka podana trzy dni później przesuwa kolejną o te trzy dni, a zaległa liczy się dalej, dopóki jej nie odhaczysz.",
    cycle_mode_schedule_hint: "Urodziny wypadają w przyszłym roku tego samego dnia — odhaczone czy nie.",
    cycle_next_label: "Następny raz",
    cycle_days_left_one: "dzień do terminu",
    cycle_days_left_other: "dni do terminu",
    cycle_days_over_one: "dzień po terminie",
    cycle_days_over_other: "dni po terminie",
    cycle_due_today: "Termin dzisiaj",
    cycle_mark_done: "Odhacz",
    cycle_done_toast: "Odhaczone — następny raz {date}",
    cycle_every_n: "Co {n} {unit}",
    cycle_every_one: "Co {unit}",
    cycle_unit_day_one: "dzień",
    cycle_unit_day_few: "dni",
    cycle_unit_day_many: "dni",
    cycle_unit_week_one: "tydzień",
    cycle_unit_week_few: "tygodnie",
    cycle_unit_week_many: "tygodni",
    cycle_unit_month_one: "miesiąc",
    cycle_unit_month_few: "miesiące",
    cycle_unit_month_many: "miesięcy",
    cycle_unit_year_one: "rok",
    cycle_unit_year_few: "lata",
    cycle_unit_year_many: "lat",
    cycle_preset_pet_dose: "Ochrona na pchły i kleszcze",
    cycle_preset_vaccine: "Szczepienie na wściekliznę",
    cycle_preset_birthday: "Urodziny",
    cycle_preset_dentist: "Przegląd u dentysty",
    cycle_notification_body: "Dzisiaj wypada termin ✨",
    cycle_paused: "Wstrzymane",
    edit: "Edytuj",
    save: "Zapisz",
    cancel: "Anuluj",
    ...
    onboarding_tasks_desc: "Podziel dzień na małe kroki, które łatwo odhaczyć. Ustaw godzinę, a dostaniesz delikatne przypomnienie — dorzuć czas trwania, jeśli zadanie ma zająć na osi czasu tyle miejsca, ile naprawdę trwa.",
    onboarding_habits_title: "Codzienne nawyki",
    onboarding_habits_desc: "Delikatne, powtarzalne przypomnienia — woda, leki, rozciąganie. Wybierz godziny, a przy okazji dni: nawyk może działać codziennie albo tylko w te dni, które zaznaczysz.",
    ...
    tour_tabs_title: "Cztery listy",
    tour_tabs_desc: "Zadania mają swój dzień, „Do zrobienia” zbiera to, co go nie ma. Nawyki i Cykle to dwie listy, które się powtarzają — za chwilę o nich więcej.",
    ...
    tour_voice_desc: "Dotknij mikrofonu i powiedz zadanie — „dentysta jutro o wpół do piątej” trafi na właściwy dzień i godzinę, od razu z przypomnieniem. Rozpoznawanie działa na Twoim urządzeniu, więc nic nigdzie nie jest wysyłane.",
    tour_voice_locked_desc: "Mikrofon zamienia wypowiedziane zadanie w zapisane — razem z dniem i godziną. Należy do Premium, tak jak FlowDay w przeglądarce i brak reklam; szczegóły znajdziesz w Ustawieniach.",
    tour_cycles_title: "Cykle",
    tour_cycles_desc: "Do tego, co wraca co kilka tygodni, miesięcy albo lat — ochrona na pchły co 5 tygodni, szczepienie co rok, urodziny. Każdy wpis pokazuje najbliższą datę i ile dni zostało; po odhaczeniu kolejny termin ustawia się sam.",
    ...
    premium_choose_plan: "Wybierz sposób płatności",
    premium_plan_monthly: "Miesięcznie",
    premium_plan_lifetime: "Jednorazowo",
    premium_plan_monthly_price: "{price} / miesiąc",
    premium_plan_lifetime_price: "{price} jednorazowo",
    premium_plan_monthly_note: "Anulujesz w każdej chwili w Google Play.",
    premium_plan_lifetime_note: "Płacisz raz. Zostaje na zawsze, nic się nie odnawia.",
    premium_plan_best_value: "Najkorzystniej",
    premium_active_monthly: "Plan miesięczny",
    premium_active_lifetime: "Zakup jednorazowy",
    premium_renews_on: "Odnawia się",
    premium_ends_on: "Kończy się",
    premium_manage_subscription: "Zarządzaj subskrypcją w Google Play",
    ...
    premium_web_locked_body: "Dostęp z przeglądarki jest częścią FlowDay Premium. Wybierz plan miesięczny albo zakup jednorazowy w aplikacji na Androida, a ta strona odblokuje się automatycznie na każdym urządzeniu, na którym się zalogujesz.",
