...
export const translations = {
  en: {
    ...
    // Notification buttons — handled without opening the app (src/lib/native.ts)
    notif_action_done: "Done",
    notif_action_postpone: "Postpone (15m)",
    notif_action_got_it: "Got it!",
    notif_action_remind_later: "Remind later",
    notif_postponed_reminder: "Postponed reminder",
    notif_postponed_nudge: "Postponed nudge",
  ...
  pl: {
    ...
    notif_action_done: "Zrobione",
    notif_action_postpone: "Odłóż (15 min)",
    notif_action_got_it: "Gotowe!",
    notif_action_remind_later: "Przypomnij później",
    notif_postponed_reminder: "Odłożone przypomnienie",
    notif_postponed_nudge: "Odłożona przypominajka",
