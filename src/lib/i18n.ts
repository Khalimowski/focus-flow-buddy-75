...
export const translations = {
  en: {
    ...
    tour_tabs_desc: "Tasks are scheduled for a specific day, To-Do holds anything for later, Habits are gentle daily reminders, and Cycles counts down to whatever comes round every few weeks or years.",
  ...
  pl: {
    ...
    tour_tabs_desc: "Zadania mają konkretny dzień, „Do zrobienia” to rzeczy na później, Nawyki to delikatne codzienne przypomnienia, a Cykle odliczają do tego, co wraca co kilka tygodni albo lat.",
