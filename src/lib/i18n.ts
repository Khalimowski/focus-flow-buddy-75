...
export const translations = {
  en: {
    ...
    time_now: "Now",
    time_plus_30m: "+30 min",
    time_plus_1h: "+1 h",
    time_set: "Set",
    time_clear: "No time",
    time_minutes_short: "min",
    time_minute_down: "One minute earlier",
    time_minute_up: "One minute later",
    time_hours: "Hours",
    time_minutes: "Minutes",
    time_keyboard_mode: "Type the time instead",
    time_grid_mode: "Pick the time instead",
  ...
  pl: {
    ...
    time_minutes_short: "min",
    time_minute_down: "Minuta wcześniej",
    time_minute_up: "Minuta później",
    time_hours: "Godziny",
    time_minutes: "Minuty",
    time_keyboard_mode: "Wpisz godzinę z klawiatury",
    time_grid_mode: "Wybierz godzinę z listy",
