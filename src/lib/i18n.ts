...
export const translations = {
  en: {
    ...
    notif_done: "Done",
    notif_postpone: "Postpone (15m)",
    notif_nudge_done: "Got it!",
    notif_nudge_postpone: "Remind later",
    postponed_reminder: "Postponed reminder",
    add_time: "Add Time",
    add_nudge: "Add Nudge",
    edit: "Edit",
    save: "Save",
  ...
  pl: {
    ...
    notif_done: "Zrobione",
    notif_postpone: "Odłóż (15 min)",
    notif_nudge_done: "Jasne!",
    notif_nudge_postpone: "Przypomnij później",
    postponed_reminder: "Odłożone przypomnienie",
